...
export const theReflectionWestlake: Project = {
  ...
  gallery: {
    ...
    images: [
      {
        src: "/projects/folder/Bể bơi vô cực.jpg",
        alt: "Bể bơi vô cực",
        caption: "Bể bơi vô cực",
      },
      {
        src: "/projects/folder/Tiện ích.jpg",
        alt: "Tiện ích",
        caption: "Tiện ích",
      },
      { src: "/projects/folder/Gym.jpg", alt: "Gym", caption: "Gym" },
      {
        src: "/projects/folder/Khu đón trả khách dành cho cư dân.jpg",
        alt: "Khu đón trả khách dành cho cư dân",
        caption: "Khu đón trả khách dành cho cư dân",
      },
      {
        src: "/projects/folder/Phối cảnh đón ks 5 sao.jpg",
        alt: "Phối cảnh đón ks 5 sao",
        caption: "Phối cảnh đón ks 5 sao",
      },
      {
        src: "/projects/folder/Vườn sóng.jpg",
        alt: "Vườn sóng",
        caption: "Vườn sóng",
      },
      {
        src: "/projects/folder/Giới tinh hoa.jpg",
        alt: "Giới tinh hoa",
        caption: "Giới tinh hoa",
      },
      {
        src: "/projects/folder/Tiện ích 2.jpg",
        alt: "Tiện ích 2",
        caption: "Tiện ích 2",
      },
      { src: "/projects/folder/Sảnh.jpg", alt: "Sảnh", caption: "Sảnh" },
      {
        src: "/projects/folder/Phối cảnh Lounge ngắm hoàng hôn.jpg",
        alt: "Phối cảnh Lounge ngắm hoàng hôn",
        caption: "Phối cảnh Lounge ngắm hoàng hôn",
      },
    ],
  },
